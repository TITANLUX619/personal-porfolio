          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                ...
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-globe"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8 mr-4" >
                <span className="lg:py-4 lg:px-3 py-4 px-3 rounded-lg text-center bg-globe"></span>
                {skills.right.map((item, i) => (
                  <span
                    key={i}
                    className="lg:py-4 lg:px-3 py-2 px-3 text-xs lg:text-base opacity-50 
                    lg:opacity-100 rounded-lg text-center bg-globe text-white"
